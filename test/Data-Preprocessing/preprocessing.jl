...
function create_mock_cohorts2()
    return DataFrame(
        event_start_date = [Date("2020-01-06"), Date("2020-01-15"), Date("2020-02-22"), Date("2020-02-21")],
...
@testset "Combination" begin
    ...
    event_start_date = [Date("2020-01-15"), Date("2020-02-21"), Date("2020-01-06"), Date("2020-02-22")],
